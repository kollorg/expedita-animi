...
[![npm](https://img.shields.io/npm/v/@kollorg/expedita-animi.svg)](https://www.npmjs.com/package/@kollorg/expedita-animi)
[![downloads](https://img.shields.io/npm/dt/@kollorg/expedita-animi.svg)](https://www.npmjs.com/package/@kollorg/expedita-animi)
[![types](https://img.shields.io/npm/types/@kollorg/expedita-animi.svg)](https://www.npmjs.com/package/@kollorg/expedita-animi)
[![licence](https://img.shields.io/github/license/mnasyrov/@kollorg/expedita-animi.svg)](https://github.com/kollorg/expedita-animi/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/mnasyrov/@kollorg/expedita-animi/badge.svg?branch=main)](https://coveralls.io/github/mnasyrov/@kollorg/expedita-animi?branch=main)
...
| --------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| [**@kollorg/expedita-animi**][@kollorg/expedita-animi/docs]             | Core elements, state and effect management | [Docs][@kollorg/expedita-animi/docs], [API][@kollorg/expedita-animi/api]             |
| [**@kollorg/expedita-animi-react**][@kollorg/expedita-animi-react/docs] | Tooling for React.js                       | [Docs][@kollorg/expedita-animi-react/docs], [API][@kollorg/expedita-animi-react/api] |
...
```
npm install @kollorg/expedita-animi @kollorg/expedita-animi-react --save
```
...
import { useConst, useObservable, useQuery } from '@kollorg/expedita-animi-react';
...
[@kollorg/expedita-animi/docs]: packages/@kollorg/expedita-animi/README.md
[@kollorg/expedita-animi/api]: packages/@kollorg/expedita-animi/docs/README.md
[@kollorg/expedita-animi-react/docs]: packages/@kollorg/expedita-animi-react/README.md
[@kollorg/expedita-animi-react/api]: packages/@kollorg/expedita-animi-react/docs/README.md
